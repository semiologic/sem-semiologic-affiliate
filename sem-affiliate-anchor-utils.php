...
class sem_affiliate_anchor_utils {
     ...
     * constructor
     */
    public function __construct( semiologic_affiliate $semiologic_affiliate, $apply_globally = true, $inc_text_widgets = true ) {
...
//		$anchor = apply_filters( 'ob_filter_anchor', $anchor );
		$anchor = $this->semiologic_affiliate->filter( $anchor );
